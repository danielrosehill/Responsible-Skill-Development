...
A short, paste-ready block for skill READMEs, CONTRIBUTING files, or plugin docs. Drop it in to signal that the project follows responsible skill-development conventions.
...
If you're forking or contributing, please preserve these conventions. See the [code of practice](https://github.com/danielrosehill/Responsible-Skill-Development/blob/main/code-of-practice.md) for the full list.
```
